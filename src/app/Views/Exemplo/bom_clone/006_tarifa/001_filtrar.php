...
Tarifa
    ...
    <p>
        ...
        <input id="buscaEmp" name="filtro.nomeEmpresa" value="" onblur="limpaId(this,'idEmpresa')" style="width:350px;"/>
        <input style="visibility: hidden;" type="text" id="idEmpresa" name="filtro.empresa" value="" />
    </p>
    ...
    <p>
        ...
        <input type="checkbox" id="filtroTarifaFutura" name="filtro.tarifaFutura" onchange="javascript:changeValorTarifas(this)" />
    </p>
    <p>
        ...
        <select id="selectValorListTarifaFutura" style="display: none;" name="filtro.valorFutura">
            <option value="" selected="selected">Selecione</option>
    ...
    <br />
        ...
        <a id="insert" href="/tarifa/insert" class="buttom_azul">Nova Tarifa</a>
    
     
        <a id="upload"  href="/tarifa/formUpload" >Importar</a>
