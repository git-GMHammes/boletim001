...
<div id="page">
	...
	<div id="container">	
		...
		<div id="inclusao">
			<span><strong class="titulo azul">Importar </strong><img src="<?= base_url(); ?>assets/bomweb/images/bomweb_setas.gif" /><strong class="titulo verde"> Tarifa Retroativa</strong></span>
			<img src="<?= base_url(); ?>assets/bomweb/images/bomweb_filtros_box_up.jpg" />	
			<form id="formUpLoad" action="/tarifa/uploadTarifaRetro" method="post" enctype="multipart/form-data">
				<fieldset>
					<p>
					Esta página permite a atualização dos valores das tarifas e a data incial e final da vigência, através da importação de uma planilha XLS,<br/>
					aceitando tarifias retroativas.<br>
					Irá excluir todos os BOMs afetados de acordo com a vigência da tarifa.
