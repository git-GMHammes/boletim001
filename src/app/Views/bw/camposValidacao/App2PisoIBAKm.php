<script type="text/babel">
    const App2PisoIBAKm = ({ formData = {}, setFormData = () => {}, parametros = {}, submitAllForms }) => {
        ...
        const handleFocus = (event) => {
            ...
            console.log('name handleFocus (src/app/Views/bw/camposValidacao/App2PisoIBAKm.php): ', name);
            console.log('value handleFocus (src/app/Views/bw/camposValidacao/App2PisoIBAKm.php): ', value);
        ...
        const handleChange = (event) => {
            const { name, value } = event.target;
            console.log('name handleChange (src/app/Views/bw/camposValidacao/App2PisoIBAKm.php): ', name);
            console.log('value handleChange (src/app/Views/bw/camposValidacao/App2PisoIBAKm.php): ', value);
        ...
        const handleBlur = async (event) => {
            const { name, value } = event.target;
            console.log('name handleBlur (src/app/Views/bw/camposValidacao/App2PisoIBAKm.php): ', name);
            console.log('value handleBlur (src/app/Views/bw/camposValidacao/App2PisoIBAKm.php): ', value);
        ...
        return (
            <div>
                <div style={formGroupStyle}>
                    <label htmlFor="codigo" style={formLabelStyle} className="form-label">#Piso I B-A (Km)<strong style={requiredField}>*</strong></label>
                    <input
