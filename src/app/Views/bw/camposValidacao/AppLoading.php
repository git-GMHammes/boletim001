<script type="text/babel">
    const AppLoading = ({ parametros = {} }) => {

        // console.log('parametros:: ', parametros);

        // Definindo valores a partir de parametros ou valores default
        const tipoLoading = parametros.tipoLoading || 'spinner';
        const carregando = parametros.carregando || true;
