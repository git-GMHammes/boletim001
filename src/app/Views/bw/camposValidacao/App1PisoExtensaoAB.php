<script type="text/babel">
    const App1PisoExtensaoAB = ({ formData = {}, setFormData = () => {}, parametros = {}, submitAllForms }) => {
        ...
        const handleFocus = (event) => {
            ...
            console.log('name handleFocus (src/app/Views/bw/camposValidacao/App1PisoExtensaoAB.php): ', name);
            console.log('value handleFocus (src/app/Views/bw/camposValidacao/App1PisoExtensaoAB.php): ', value);
        ...
        const handleChange = (event) => {
            const { name, value } = event.target;
            console.log('name handleChange (src/app/Views/bw/camposValidacao/App1PisoExtensaoAB.php): ', name);
            console.log('value handleChange (src/app/Views/bw/camposValidacao/App1PisoExtensaoAB.php): ', value);
        ...
        const handleBlur = async (event) => {
            const { name, value } = event.target;
            console.log('name handleBlur (src/app/Views/bw/camposValidacao/App1PisoExtensaoAB.php): ', name);
            console.log('value handleBlur (src/app/Views/bw/camposValidacao/App1PisoExtensaoAB.php): ', value);
        ...
        return (
            <div>
                <div style={formGroupStyle}>
                    <label htmlFor="codigo" style={formLabelStyle} className="form-label">#Extensão A-B<strong style={requiredField}>*</strong></label>
                    <input
