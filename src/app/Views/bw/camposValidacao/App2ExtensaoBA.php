<script type="text/babel">
    const App2ExtensaoBA = ({ formData = {}, setFormData = () => {}, parametros = {}, submitAllForms }) => {
        ...
        const handleFocus = (event) => {
            ...
            console.log('name handleFocus (src/app/Views/bw/camposValidacao/App2ExtensaoBAz.php): ', name);
            console.log('value handleFocus (src/app/Views/bw/camposValidacao/App2ExtensaoBAz.php): ', value);
        ...
        const handleChange = (event) => {
            const { name, value } = event.target;
            console.log('name handleChange (src/app/Views/bw/camposValidacao/App2ExtensaoBAz.php): ', name);
            console.log('value handleChange (src/app/Views/bw/camposValidacao/App2ExtensaoBAz.php): ', value);
        ...
        const handleBlur = async (event) => {
            const { name, value } = event.target;
            console.log('name handleBlur (src/app/Views/bw/camposValidacao/App2ExtensaoBAz.php): ', name);
            console.log('value handleBlur (src/app/Views/bw/camposValidacao/App2ExtensaoBAz.php): ', value);
        ...
        return (
            <div>
                <div style={formGroupStyle}>
                    <label htmlFor="codigo" style={formLabelStyle} className="form-label">#Extensão B-A<strong style={requiredField}>*</strong></label>
                    <input
