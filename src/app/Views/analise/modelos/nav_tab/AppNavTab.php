...
<div class="app_nav_tab" data-result='<?php echo json_encode($parametros_backend); ?>'></div>

<script type="text/babel">
    const AppNavTab = () => {

        // Variáveis recebidas do Backend
        const parametros = JSON.parse(document.querySelector('.app_nav_tab').getAttribute('data-result'));
    ...
    const rootElement = document.querySelector('.app_nav_tab');
    const root = ReactDOM.createRoot(rootElement);
    root.render(<AppNavTab />);
</script>
<?php
$parametros_backend = array();
?>